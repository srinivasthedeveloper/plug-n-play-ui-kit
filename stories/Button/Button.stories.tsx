...
const ButtonWithRef: any = (args: ButtonProps) => {
  ...
  return (
    <div style={{ display: 'flex', gap: '5px', flexDirection: 'column' }}>
      <span style={{ background: '#fff', padding: '4px' }}>
        ButtonA has a ref and will console log on click action
      </span>
      <span style={{ background: '#fff', padding: '4px' }}>
        ButtonB has a onclick function which triggers buttonA onclick action
      </span>
